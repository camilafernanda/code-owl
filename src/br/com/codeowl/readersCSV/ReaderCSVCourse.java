...
public class ReaderCSVCourse {
    ...
    public void readCourseFile(String pathName, Map<String, Subcategory> subcategories) {
        try {
            ...
            String modifiedFileName = "planilha-dados-escola-Curso-modificado.csv";
            ...
            while ((line = fileCSVCourse.readLine()) != null) {
                ...
                int estimatedTime = CSVValidations.validateIntField(value[2]);
                boolean availability = value[3].equals("PÚBLICA");
                String targetPublic = CSVValidations.validateStringNullField(value[4]);
                String instructorName = CSVValidations.validateStringNullField(value[5]);
                String courseOutline = CSVValidations.validateStringNullField(value[6]);
                String skills = CSVValidations.validateStringNullField(value[7]);
                String subcategoryCode = CSVValidations.validateStringNullField(value[8]);
